        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://github.com/aoaostar/toolbox" target="_blank"><i class="layui-icon layui-icon-release" style="font-size: 16px;"></i> 开源地址</a>\n' +
                    '<a class="more-menu-item" href="http://www.aoaostar.com" target="_blank"><i class="layui-icon layui-icon-website"></i> 官方网站</a>\n' +
                    '<a class="more-menu-item" href="http://t.me/aoaostar" target="_blank"><i class="layui-icon layui-icon-dialogue" style="font-size: 19px;"></i> TG聊天群</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
